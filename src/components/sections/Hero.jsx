          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-[#111827] tracking-tight !leading-tight mb-6 text-balance">
              ...
              <span className="relative inline-block">
                <span className="relative z-10 text-transparent bg-clip-text bg-gradient-to-r from-primary via-primary-light to-[#D92779]">
                  Chronic Pain
                </span>
                <svg
                  className="absolute w-full h-8 -bottom-2 left-0 text-primary-light"
                  viewBox="0 0 100 25"
            ...
            <p className="text-lg md:text-xl text-gray-700 mb-8 max-w-2xl leading-relaxed">
              ...
              <b>chronic pain</b> and <b>lifestyle diseases</b>, focusing on
              treating the <b>root cause</b> rather than just the symptoms
              through our proprietary 4R Approach: Recognize, Remedy, Restore,
              Regenerate.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link to="tel:919845155449" className="w-full sm:w-fit">
                <Button
                  size="lg"
                  variant="outline"
                  className="text-primary-dark border-primary-dark hover:bg-primary-darkest hover:text-white w-full"
                >
