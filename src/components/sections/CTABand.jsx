...
const CTABand = () => {
    return (
        <section className="container !pb-32 px-4 md:px-6 relative z-10">
            <div className="relative overflow-hidden isolate">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 flex flex-col md:flex-row items-center justify-between gap-12">
                    <div className="max-w-3xl text-center md:text-left">
                        <span className="text-accent font-bold tracking-widest uppercase text-sm mb-4 block">Transformation Awaits</span>
                        ...
                        <div className="flex flex-col sm:flex-row gap-5">
                            <Button size="lg" className="bg-accent text-primary-dark hover:bg-white hover:scale-105 transition-all duration-300 font-bold px-8 h-14 text-lg shadow-[0_0_20px_rgba(255,255,255,0.3)]">
                    ...
                    <div className="text-center">
                        ...
                        <span className="text-xs text-accent uppercase tracking-widest">Holistic</span>
                    </div>
                </div> */}
                </div>
            </div>
