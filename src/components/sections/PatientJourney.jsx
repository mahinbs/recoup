                ...
                <div className="grid grid-cols-1 md:grid-cols-5 gap-8 relative z-10">
                    {steps.map((step, index) => (
                        <motion.div
                            ...
                            viewport={{ once: true }}
                        >
                            <div className="w-16 h-16 rounded-full bg-secondary flex items-center justify-center text-primary-dark mb-4 border-2 border-white shadow-lg relative z-10 hover:bg-accent hover:text-white transition-colors duration-300">
                                {step.icon}
